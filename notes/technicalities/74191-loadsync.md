...
For the XY register pair, the 74138 decoder outputs are active-low. For the SP, that load signal comes from the microprogrammed Control Unit, and it can be coded to be output high by default, and only when loading it goes low.
