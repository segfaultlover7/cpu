...
### Specs
- This model does not have interrupts or perform [[AD-03 Fetch-Execute Overlap]]
- It contains 4 General purpose registers (B,C,X,Y) ([[AD-01 Register File Increment]])
- There are 2 bits dedicat[[AD-01 Register File Increment]]ed to the register selector (bits IRH0-1)
- The opcode is 6 bits long (bits IRH2-7), meaning 64 available instructions
- The microstep counter has 4 dedicated bits ([[AD-02 Microstep Counter Reduction]])
...
### Cycle Inefficiency
This is related to the [[AD-03 Fetch-Execute Overlap]]. This change felt natural just by seeing the amount of cycles that could be saved by making this change. 
## Design made in Digital

![[Pasted image 20260903191554.png]]
